...
- Опциональная привязка минут к шагу 5 (переключатель) и кнопка «выставить текущее время».
...
Под циферблатом — переключатель «5 минут» (привязка минут к шагу 5) и кнопка «Сейчас»
